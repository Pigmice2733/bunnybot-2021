  ...
  public void periodic(){
    ...
    public void ColorSort() {
      ...
      //colorSensorMotor.set(ControlMode.PercentOutput, 0.5);
        ...
        //red detection loop
        if(detectedColor.red/detectedColor.blue > redScaleToBlue && detectedColor.red/detectedColor.green > redScaleToGreen){
        ...
        else if(detectedColor.blue/detectedColor.red > blueScaleToRed && detectedColor.blue/detectedColor.green > blueScaleToGreen)
        {
          colorSensorMotor.set(ControlMode.PercentOutput, -SystemConfig.ColorSorterConfiguration.colorSensorMotorSpeed);
